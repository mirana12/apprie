...
enum FxTextFieldType { email, password, name, address, mobileNumber, profilecategory, affiliation, location, languages, username, confirmpassword, position }
    ...
    if (labelText == null) {
      switch (widget.textFieldType) {
        ...
        case FxTextFieldType.password:
          ...
          break;
        case FxTextFieldType.confirmpassword:
          maxLines = 1;
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
        ...
        case FxTextFieldType.username:
          ...
          keyboardType = keyboardType ?? TextInputType.text;
          break;
        case FxTextFieldType.profilecategory:
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
                      Icons.person_outline,
          ...
          keyboardType = keyboardType ?? TextInputType.text;
          break;
        case FxTextFieldType.affiliation:
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
                      Icons.dashboard,
                  ...
                  : null);
          labelText = "Add affiliation if not in the list";
          keyboardType = keyboardType ?? TextInputType.text;
          break;
        /*case FxTextFieldType.position:
          prefixIcon = prefixIcon ??
        ...
        case FxTextFieldType.location:
          ...
          break;
        case FxTextFieldType.languages:
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
                      Icons.language,
